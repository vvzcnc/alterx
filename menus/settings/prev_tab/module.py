...
class func:
    ...
    def execute(self):
        _logger.info( "Button PrevTab clicked")
        
        if self.that.widgets.tabSettings.currentIndex() < 0 :
            self.that.widgets.tabSettings.setCurrentIndex(0)
        elif self.that.widgets.tabSettings.currentIndex() < 1:
            self.that.widgets.tabSettings.setCurrentIndex(self.that.widgets.tabSettings.count()-1)
        else:
