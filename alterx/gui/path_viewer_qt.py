...
try:
        ...
        printError(_("Qtvcp error with path_viewer, package python-pyqt5.qtopengl not installed"))
...
try:
        ...
        printError(_("Qtvcp Error with path_viewer, package python-openGL not installed"))
        LIB_GOOD = False
